...
impl Engine {
    ...
    pub fn update(&mut self) {
        {
            let mut time = self.world.resource_mut::<resonance_core::Time>();
            time.update();
        }
        ...
        {
            let delta = self.world.resource::<resonance_core::Time>().delta();
            let mut fixed_time = self.world.resource_mut::<resonance_core::FixedTime>();
            fixed_time.accumulate(delta);
        }

        while self
            .world
            .resource::<resonance_core::FixedTime>()
            .should_update()
        {
            {
                let mut tick = self.world.resource_mut::<resonance_core::GameTick>();
                tick.increment();
            }
            ...
            self.world
                .resource_mut::<resonance_core::FixedTime>()
                .consume_step();
        }
