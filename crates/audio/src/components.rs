...
use resonance_assets::AssetHandle;
...
pub struct AudioSource {
    ...
    pub audio_handle: Option<AssetHandle<resonance_assets::AudioData>>,
...
impl AudioSource {
    ...
    pub fn new(audio_handle: AssetHandle<resonance_assets::AudioData>) -> Self {
        Self {
